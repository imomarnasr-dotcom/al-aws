          ...
          <>
            ...
            >
              <div className="flex items-center gap-4">
                <img src="/logo.jpg" alt="Logo" className="w-12 h-12 rounded-xl object-contain shadow-sm border border-gray-100 bg-white" />
                <div>
              ...
              <div className="flex items-center gap-6">
                <div className="hidden md:flex flex-col items-end text-sm font-bold text-gray-700">
                  <div className="flex items-center gap-2">
                    <span className="text-primary">{currentDateTime.toLocaleDateString('ar-SA-u-ca-islamic', { year: 'numeric', month: 'long', day: 'numeric' })} هـ</span>
