    ...
    <header className="glass-card border-b border-white/20 px-6 py-4 flex justify-between items-center sticky top-0 z-50 h-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          <img src={logoImage} alt="Logo" className="w-12 h-12 rounded-xl object-contain shadow-sm border border-gray-100" />
        ...
        <div className="flex items-center gap-3 md:hidden">
          <img src={logoImage} alt="Logo" className="w-10 h-10 rounded-xl object-contain shadow-sm border border-gray-100" />
        </div>
      </div>
